...
Note:  
This extension is deliberately designed to work *slowly* and will also make a random pause between 2 and 4 minutes after download every 100 conversations. This is to avoid any potential issues like rate limiting that ChatGPT might implement.  
