...
This command **requires** the project directory as an argument via `/Users/alex/ab/gpt-exporter`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/alex/ab/gpt-exporter/.autocoder/prompts/app_spec.txt` and `/Users/alex/ab/gpt-exporter/.autocoder/prompts/initializer_prompt.md`

If `/Users/alex/ab/gpt-exporter` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/alex/ab/gpt-exporter/.autocoder/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/alex/ab/gpt-exporter/.autocoder/prompts/app_spec.txt`
...
**Output path:** `/Users/alex/ab/gpt-exporter/.autocoder/prompts/initializer_prompt.md`
...
**Output path:** `/Users/alex/ab/gpt-exporter/.autocoder/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/alex/ab/gpt-exporter/.autocoder/prompts/`!
>
> **Files created:**
> - `/Users/alex/ab/gpt-exporter/.autocoder/prompts/app_spec.txt`
> - `/Users/alex/ab/gpt-exporter/.autocoder/prompts/initializer_prompt.md`
>
